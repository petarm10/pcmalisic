...
use Mild\Api\Customizer\Sidebar;
use Mild\Api\Customizer\Header;
use Mild\Api\Customizer\Footer;
...
class Customizer {
	...
	public function output() {
	  echo '<!--Customizer CSS--> <style type="text/css">';
		echo self::css( '#sidebar', 'background-color', 'mild_sidebar_background_color' );
		echo self::css( '.site-footer', 'background-color', 'mild_footer_background_color' );
		echo self::css( '.site-header', 'background-color', 'mild_header_background_color' );
		echo self::css( '.site-header', 'color', 'mild_header_text_color' );
		echo self::css( '.site-header a', 'color', 'mild_header_link_color' );

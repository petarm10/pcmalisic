...
use Mild\Api\Settings;
use Mild\Api\Callbacks\SettingsCallback;
...
class Admin {
	...
	private function enqueue() {
		...
		$pages = array( 'toplevel_page_mild' );
	...
	private function enqueue_faq( Settings $settings ) {
		...
		// Pages array to where enqueue scripts
		$pages = array( 'mild_page_mild_faq' );
	...
	private function settings() {
	   // Register settings
		$args = array(
			array(
				'option_group' => 'mild_options_group',
				'option_name'  => 'first_name',
				'callback'     => array( $this->callback, 'mild_options_group' ),
			),
			array(
				'option_group' => 'mild_options_group',
				'option_name'  => 'mild_test2',
			),
		);
	   ...
	   // Register sections
		$args = array(
			array(
				'id'       => 'mild_admin_index',
				'title'    => 'Settings',
				'callback' => array( $this->callback, 'mild_admin_index' ),
				'page'     => 'mild',
			),
		);

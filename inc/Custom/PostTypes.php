	...
	public function custom_post_type() {
		...
		$custom_posts = array(
			...
			array(
				...
				'description'        => 'Webinar Custom Post Type',
				'public'             => true,
				'publicly_queryable' => true,
				'show_ui'            => true,
				'show_in_menu'       => true,
			...
			array(
				...
				'text_domain'        => 'mild',
				'supports'           => array( 'title', 'editor', 'thumbnail' ,'excerpt', 'author' ),
				'description'        => 'Solution Custom Post Type',
				'public'             => true,
				'publicly_queryable' => true,
				'show_ui'            => true,
				'show_in_menu'       => true,
			...
			// array(
			// 	'slug'               => 'success',
			// 	'singular'           => 'Insight Old',
			// 	'plural'             => 'Insights Old',
			// 	'menu_icon'          => 'dashicons-book',
			// 	'menu_position'      => 20,
			// 	'text_domain'        => 'mild',
			// 	'supports'           => array( 'title', 'editor', 'thumbnail' ,'excerpt', 'author' ),
			// 	'description'        => 'Success Stories Custom Post Type',
			// 	'public'             => true,
			// 	'publicly_queryable' => true,
			// 	'show_ui'            => true,
			// 	'show_in_menu'       => true,
			...
			array(
				...
				'text_domain'        => 'mild',
				'supports'           => array( 'title', 'editor', 'thumbnail' ,'excerpt', 'author' ),
				'description'        => 'Insights Custom Post Type',
				'public'             => true,
				'publicly_queryable' => true,
				'show_ui'            => true,
				'show_in_menu'       => true,
			...
			array(
				...
				'description'        => 'Downloads Custom Post Type',
				'public'             => true,
			...
			array(
				'slug'               => 'slider-items',
				'singular'           => 'Slider Item',
				'plural'             => 'Slider Items',
				'menu_icon'          => 'dashicons-slides',
				'menu_position'      => 55,
				'text_domain'        => 'mild',
				'supports'           => array( 'title', 'excerpt', 'thumbnail' ),
				'description'        => 'Slider Items Custom Post Type',
				'public'             => true,
				'publicly_queryable' => false,
				'show_ui'            => true,
				'show_in_menu'       => true,

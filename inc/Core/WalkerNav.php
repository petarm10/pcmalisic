...
class WalkerNav extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        if($depth == 0){
            $output .= "\n$indent<ul class=\"dropdown-menu$submenu megamenu depth_$depth\" >\n";
        }else{
            $output .= "\n$indent<ul class=\"$submenu megamenu depth_$depth\" >\n";
        }
	}
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$classes[] = ( $args->has_children ) ? 'dropdown has-megamenu' : '';
